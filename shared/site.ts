...
export const DEFAULT_CONTENT: ContentSeed[] = [
  ...
  [
    ...
    "hero",
    "title",
    "The roles behind a coordinated growth program.",
    "text",
    "Page title",
    0,
  ],
  [
    ...
    "hero",
    "body",
    "Approved team biographies and credentials have not yet been supplied. This page describes the work required without inventing people or qualifications.",
    "textarea",
    "Page introduction",
    1,
  ],
